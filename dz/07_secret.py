...
a = print(secret_message[0][3:4])
b = print(secret_message[1][9:13])
c = print(secret_message[2][5:15:2])
d = print(secret_message[3][-20:-26:-1])
e =print(secret_message[4][-12:-17:-1])
